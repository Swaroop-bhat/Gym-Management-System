...
<div class="container">
	<div class="row">
		<img src="res/logo1.png" style="height:100px" class="col-lg-2 col-md-6">
		<h1 class="col-lg-10 col-md-6 text-center align-self-center text-uppercase">GYM  MANAGEMENT SYSTEM</h1>
	</div>
	<div class="row">
		<div id="adarsh" class="col-lg-8 col-md-6 col-sm-12 carousel slide carousel-fade" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="res/about.png" style="height:450px" class="d-block w-100" alt="About Gym">
		    </div>
		    <div class="carousel-item">
		      <img src="res/Fitness.png" style="height:450px" class="d-block w-100" alt="Fitness">
		    </div>
		    <div class="carousel-item">
		      <img src="res/goal.png" style="height:450px" class="d-block w-100" alt="Goal">
		    </div>
		  </div>
		...
		<form class="col-lg-4 col-md-6 col-sm-12 shadow-lg p-4 align-self-center" action="LoginServlet" method="post">
			<h1 class="text-center text-success display-6">Gym Admin Login</h1>
